...
def sunny_beach_data():
    return [
        ("Vlas - Petrol Station", "Sveti Vlas main road stop", 42.7130, 27.7580, "https://goo.gl/maps/FUQ3s5GRRZ2veEA37", "the main road stop by the petrol station in Sveti Vlas", VehicleType.doubledecker, "08:20", "13:30", "18:20", "09:20", "11:15", "16:50"),
        ("Mercury Grand Market", "Mercury Grand Market, Sunny Beach", 42.7088, 27.7300, "https://goo.gl/maps/PiBemv5nEPFhMGE58", "the bus stop on the main road by Mercury Grand Market", VehicleType.doubledecker, "08:20", "13:30", "18:20", "09:20", "11:15", "16:50"),
        ("Secrets Resort - Main Road Bus Stop", "Secrets Resort main road stop", 42.7068, 27.7248, "https://goo.gl/maps/eHAkk6VDaFki1Gyy7", "the main road bus stop outside Secrets Resort", VehicleType.doubledecker, "08:20", "13:30", "18:25", "09:20", "11:20", "16:55"),
        ("Helena / Zora - Main Road Bus Stop", "Helena / Zora main road stop", 42.7038, 27.7195, "https://goo.gl/maps/MSCHRXSC9N2rTPe56", "the main road stop serving Helena and Zora", VehicleType.doubledecker, "08:25", "13:40", "18:25", "09:25", "11:20", "16:55"),
        ("Efir Bus Stop", "Efir main road stop", 42.7010, 27.7160, "https://goo.gl/maps/L88VqkFXim8txLAG7", "the main road stop at Efir", VehicleType.doubledecker, "08:30", "13:40", "18:30", "09:30", "11:30", "17:00"),
        ("Palm Court Bus Stop", "Palm Court main road stop", 42.6992, 27.7128, "https://goo.gl/maps/84JYbvEhqcExRKMo8", "the main road stop near Palm Court", VehicleType.doubledecker, "08:30", "13:40", "18:30", "09:30", "11:30", "17:00"),
        ("Opal Bus Stop", "Opal main road stop", 42.6975, 27.7095, "https://goo.gl/maps/thRd9PqTyURo9syh9", "the main road stop at Opal", VehicleType.doubledecker, "08:30", "13:50", "18:30", "09:30", "11:30", "17:00"),
        ("Flower Street Main Bus Stop", "Flower Street, Sunny Beach", 42.6945, 27.7060, "https://goo.gl/maps/ydTcnW4c54gfrKEy5", "the main road bus stop by Flower Street", VehicleType.doubledecker, "08:35", "13:50", "18:35", "09:35", "11:35", "17:05"),
        ("Hotel Best Western / Sveshest", "Best Western / Sveshest main road stop", 42.6928, 27.7038, "https://goo.gl/maps/XLgoFHZMtvYQzErz8", "the main road stop next to Best Western / Sveshest", VehicleType.doubledecker, "08:35", "13:50", "18:35", "09:35", "11:35", "17:05"),
        ("Royal Sun / Arda Bus Stop", "Royal Sun / Arda main road stop", 42.6900, 27.7012, "https://goo.gl/maps/FZEmFQbW986vxvdf8", "the main road stop for Royal Sun and Arda", VehicleType.doubledecker, "08:40", "14:00", "18:40", "09:40", "11:40", "17:10"),
        ("Black Sea Hotel Bus Stop", "Black Sea Hotel main road stop", 42.6885, 27.6990, "https://goo.gl/maps/Q7MQuRPrmgoi1aWA7", "the main road stop at Black Sea Hotel", VehicleType.doubledecker, "08:40", "14:00", "18:40", "09:40", "11:40", "17:10"),
        ("Belleville / Cacao Bus Stop", "Belleville / Cacao main road stop", 42.6860, 27.6970, "https://maps.app.goo.gl/4GuQCq4pseYHiKSS9", "the main road stop for Belleville and Cacao", VehicleType.doubledecker, "08:45", "14:00", "18:45", "09:45", "11:45", "17:15"),
        ("Football Stadium Bus Stop", "Nessebar football stadium stop", 42.6840, 27.6952, "https://goo.gl/maps/3Jv6CfDYzksM1k4h7", "the main road bus stop by the football stadium", VehicleType.doubledecker, "08:45", "14:10", "18:45", "09:45", "11:45", "17:15"),
        ("Festa Panorama Ness Bus Stop", "Festa Panorama stop", 42.6822, 27.6938, "https://goo.gl/maps/EMtz694HAMgxYBkHA", "the stop by Festa Panorama in Nessebar", VehicleType.doubledecker, "08:50", "14:15", "18:50", "09:50", "11:50", "17:20"),
        ("Aqua Paradise Hotel - with Minibus", "Aqua Paradise Hotel", 42.6708, 27.6992, "https://goo.gl/maps/euFhKiq9vnuYw96v5", "the hotel entrance at Aqua Paradise", VehicleType.minibus, "08:40", "14:10", "18:40", "09:36", "11:40", "17:10"),
        ("SOL Nessebar Palas - with Minibus", "SOL Nessebar Palace", 42.6688, 27.7055, "https://goo.gl/maps/B8xy1HMJUf6ZtduB7", "the entrance area at SOL Nessebar Palas", VehicleType.minibus, "08:40", "14:10", "18:40", "09:40", "11:40", "17:10"),
        ("Panteleimon Bus Stop - with Minibus", "Panteleimon stop", 42.6670, 27.7090, "https://goo.gl/maps/wrJPDFMzWZstkF2Q8", "the minibus stop by Panteleimon", VehicleType.minibus, "08:40", "14:15", "18:45", "09:40", "11:40", "17:10"),
        ("Biliyana Ness - with Minibus", "Biliyana stop", 42.6652, 27.7110, "https://goo.gl/maps/W2mTexBBR7FTfDkv8", "the minibus stop by Biliyana", VehicleType.minibus, "08:45", "14:15", "18:45", "09:45", "11:45", "17:15"),
        ("Oasis Ness - with Minibus", "Oasis Nessebar", 42.6635, 27.7132, "https://goo.gl/maps/eZmUp6YTpiP5qfg88", "the minibus stop by Oasis Nessebar", VehicleType.minibus, "08:45", "14:15", "18:45", "09:45", "11:45", "17:15"),
        ("Marina Palas - with Minibus", "Marina Palace", 42.6618, 27.7158, "https://maps.app.goo.gl/57mvX6Bg25WBr8wJ6", "the minibus stop at Marina Palas", VehicleType.minibus, "08:50", "14:20", "18:50", "09:50", "11:45", "17:15"),
        ("Meet at Catamaran", "Nessebar old town catamaran meeting point", 42.6595, 27.7210, "https://goo.gl/maps/TifgamQdsdFoDZbf7", "the catamaran boarding point", VehicleType.minibus, "08:55", "14:25", "18:55", "09:55", "11:50", "17:20"),
    ]
...
def seed() -> None:
    ...
    with session_scope() as db:
        ...
        obzor_stops = {
            "Sunrise All Suite Resort": ("Sunrise All Suite Resort", 42.8150, 27.8800, "", "outside Sunrise All Suite Resort", VehicleType.guide, "09:50"),
            "Sol Luna Bay": ("Sol Luna Bay", 42.8200, 27.8850, "", "outside Sol Luna Bay", VehicleType.guide, "10:00"),
            "Clubhotel Miramar": ("Clubhotel Miramar", 42.8170, 27.8950, "", "outside Clubhotel Miramar", VehicleType.guide, "10:15"),
            "Helios Bay": ("Helios Bay", 42.8135, 27.8990, "", "outside Helios Bay", VehicleType.guide, "10:25"),
            "Central Bus Station": ("Central Bus Station", 42.8195, 27.8775, "", "at the Central Bus Station on the main road", VehicleType.guide, "10:30"),
            "Luk Oil Petrol Station": ("Luk Oil Petrol Station", 42.8212, 27.8720, "", "outside Luk Oil Petrol Station", VehicleType.guide, "10:30"),
        }
        ...
        pomorie_rows = [
            ("Saint George", "Saint George", "Saint George", 42.5560, 27.6360, "https://goo.gl/maps/USrsVCbsj9C2", "outside Saint George", "08:05"),
            ("Hotel Grand Pomori", "Grand Pomori", "Hotel Grand Pomori", 42.5575, 27.6295, "https://goo.gl/maps/yF3FcK8Wcko", "outside Hotel Grand Pomori", "08:10"),
            ("Sunset Resort", "Sunset Resort", "Sunset Resort", 42.5595, 27.6210, "https://goo.gl/maps/GjpMSgVunNC2", "outside Sunset Resort", "08:15"),
            ("Hotel Wave", "Wave", "Hotel Wave", 42.5730, 27.6080, "https://g.page/WaveResortPomorie?share", "outside Hotel Wave", "08:35"),
            ("Hotel Aqua Paradise", "Aqua Paradise", "Hotel Aqua Paradise", 42.6705, 27.6990, "https://goo.gl/maps/HrkMA2b2m9wvUJK39", "outside Hotel Aqua Paradise", "08:40"),
        ]
